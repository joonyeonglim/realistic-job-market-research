...
export const EXTENDED_ADAPTERS = ["groupby", "career", "remoteok", "weworkremotely", "linkedin", "jobkorea", "incruit", "official_ats", "peoplenjob"];
export const PROBE_ONLY = ["catch", "himalayas", "robert_walters", "jac_korea", "jobplanet", "rocketpunch", "work24", "job_alio", "gojobs", "nst", "onest", "jobaba", "seoul_jobs", "seoul_public", "gyeonggi_public"];
export const AUTHENTICATED_HANDOFF = ["remember"];
