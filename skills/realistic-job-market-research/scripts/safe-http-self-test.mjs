...
import { isBlockedAddress, matchesDomain, validatePublicUrl } from "./safe-http.mjs";
...
assert.equal(matchesDomain("jobs.example.com", "example.com"), true);
assert.equal(matchesDomain("evilexample.com", "example.com"), false);
