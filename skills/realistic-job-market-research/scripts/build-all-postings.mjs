...
const sourceAdapterCounts = plan.sources.reduce((counts, entry) => {
  counts[entry.adapter_status] = (counts[entry.adapter_status] || 0) + 1;
  return counts;
}, {});
...
const manifest = {
  ...
  source_adapter_counts: sourceAdapterCounts,
