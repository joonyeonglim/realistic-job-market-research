...
```bash
node scripts/python-runner.mjs scripts/derive_swing_weights.py assets/swing-weights.example.json
```
...
```bash
node scripts/python-runner.mjs scripts/evaluate_outcomes.py /private/path/outcomes.json
```
